...
# WELCOME NOTE
welcome_note = Label(text="Fill up the form before starting the quiz.", font=("Times New Roman", 15, "bold"))
welcome_note.grid(column=2, row=4, columnspan = 2, pady=(0, 30))


# USER NAME
user_name_label = Label(text="Student's Name:", font=("Courier", 12, "bold"))
user_name_label.grid(column=2, row=5, sticky = "w")

user_name_input = Entry( width=30)
user_name_input.grid(column=3, row=5, padx=(20, 0))


# INSTRUCTOR'S NAME
instructors_name_label = Label(text="Instructor's Name:", font=("Courier", 12, "bold"))
instructors_name_label.grid(column=2, row=6 , pady=(20, 0), sticky = "w")

instructors_name_input = Entry(width=30)
instructors_name_input.grid(column=3, row=6, padx=(20, 0), pady=(10, 0))

# YEAR AND SECTION
year_and_section_label = Label(text="Year and Section:", font=("Courier", 12, "bold"))
year_and_section_label.grid(column=2, row=7 , pady=(20, 0), sticky = "w")

year_and_section_input = Entry(width=30)
year_and_section_input.grid(column=3, row=7, padx=(20, 0), pady=(10, 0))

# DATE
date = Label(text=f"Date: {datetime.now().strftime('%B %d,%Y')}", font=("Courier", 12, "bold"))
date.grid(column=2, row=8, sticky = "w", pady=(20, 0))
